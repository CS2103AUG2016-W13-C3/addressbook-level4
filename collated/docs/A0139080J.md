                ...
                <p>
                    <ul id="first-layer">
                        ...
                        <ul id="second-layer">
                            ...
                            <li><a href="#list"> Listing To-Dos with time constraint</a></li>
...
``` html
                ...
                <p>An <em>Event</em> is an activity happening within a time window, with <code>start_datetime</code> and <code>end_datetime</code> fields to represent the time window. If no time is given, a default time of 00:00AM is assigned to the start date and 23:59PM to the end date. If a date is given instead, it is considered a full day event. To associate tags with the <em>Event</em>, prefix each of them with a <code>#</code>. In <em>CommanDo</em>, every <em>Event</em> from the current day onwards is listed in the left panel chronologically:</p>

                <p>The use of keywords <code>daily</code>, <code>weekly</code>, <code>monthly</code> or <code>yearly</code> allows you to have recurring events on the same day of every day, week, month or year.</p>
                ...
                <pre class="command-format"><span class="inputstart">&gt;&gt;</span> add <span>&lt;description&gt;</span> on <span>&lt;date&gt;</span> [daily/weekly/monthly/yearly] [#<span>&lt;tag&gt;</span>...] </pre>
...
``` html
                ...
                <span>What it does:  Changes the description of that task to <code>shopping trip to IKEA</code> and replaces all of its tags with <code>#family</code>.</span>
...
``` html
                ...
                <h3>1. Double-clicking on <code>commando.jar</code> doesn't open up <em>CommanDo</em> or gives an error.</h3>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><code>coming friday</code></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td><code>Sept 29</code></td>
                                <td><code>next saturday</code></td>
                                <td></td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="datagrid">
                    <table class="black">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>List To-Dos</td>
                                <td><pre><span class="inputstart">&gt;&gt;</span> list from <span>&lt;start_datetime&gt;</span> to <span>&lt;end_datetime&gt;</span></td>
                            </tr>
                            <tr>
                                <td>Finish To-Dos</td>
