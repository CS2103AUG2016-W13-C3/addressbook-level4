...
``` html
                ...
                <p><em>CommanDo</em> is a to-do list manager. It is designed to cater for the needs of people who type fast and has a user interface shown in the picture below. to-dos are displayed on a graphical user interface (GUI), split into 2 panels of <em>Events</em> and <em>Tasks</em>. The user manage his/her to-do list by typing commands on a text input - just like in a Command Line Interface (CLI).</p>

                <figure>
                    <img src="https://github.com/CS2103AUG2016-W13-C3/main/blob/master/docs/images/Ui.png?raw=true" width="600">
                    <figcaption><em>CommanDo</em> complete view</figcaption>
                </figure>
...
###### \developer.html
``` html
                <h3 id="architecture-diagram">Architecture</h3>
                ...
                <p><code>MainApp.java</code> is the entry point of the application. It is responsible for:</p>
                ...
                <ul>
                    <li>
                        <a href="#ui-api"><strong><em>UI</em> Component</strong></a>: Acts as the middleman between the user and the API provided by <em>Logic</em> (package <code>seedu.commando.ui</code>)
                    </li>
                    <li>
                        <a href="#logic-api"><strong><em>Logic</em> Component</strong></a>: Executes commands from the UI, using the API provided by <em>Model</em> and <em>Storage</em> (package <code>seedu.commando.logic</code>)
                    </li>
                    <li>
                        <a href="#model-api"><strong><em>Model</em> Component</strong></a>: Defines how data is represented and holds the data of the application in-memory (package <code>seedu.commando.model</code>)
                    </li>
                    <li>
                        <a href="#storage-api"><strong><em>Storage</em> Component</strong></a>: Reads data from and writes data to the file system (package <code>seedu.commando.storage</code>)
                    </li>
                </ul>
                ...
                <p>
                    ...
                    <blockquote>
                        Note that for the <em>Model</em> component, besides the API defined by <code>Model.java</code>, it also contains data structures such as <code>UserPrefs.java</code> and <code>ReadOnlyToDo.java</code> that the other components are dependent on. Such dependencies are listed in the later section <a href="#model-api">Model API</a>
                    </blockquote>

                <p>Underlying all 4 components is the package <code>seedu.commando.commons</code>. It is a collection of utility classes and application constants that are used throughout the application. We also use <a href="#event-driven-design">Event Driven Design</a> for components to communicate with one another.</p>

                <h4>What happens in a command execution</h4>

                <figure>
                    <img src="https://i.imgur.com/OvMZBs9.jpg" width="600">
                    <figcaption>Sequence Diagram of command <code>add plan shopping trip #lunch</code></figcaption>
                </figure>

                <p>(Step-by-step description on the flow of execution)</p>

                <h3 id="ui-api">UI API and Component</h3>

                <figure>
                    <img src="https://raw.githubusercontent.com/CS2103AUG2016-W13-C3/main/master/docs/images/UI API.PNG" max-width="600">
                    <figcaption>API of UI component</figcaption>
                </figure>

                <p>
                    (Description about what the API does to be filled in here)
                </p>

                <h3 id="logic-api">Logic API and Component</h3>

                <figure>
                    <img src="https://raw.githubusercontent.com/CS2103AUG2016-W13-C3/main/master/docs/images/Logic API.PNG" max-width="600">
                    <figcaption>API of Logic component</figcaption>
                </figure>
                ...
                <h3 id="model-api">Model API and Component</h3>

                <figure>
                    <img src="https://raw.githubusercontent.com/CS2103AUG2016-W13-C3/main/master/docs/images/Model API 1.PNG" max-width="600">
                    <img src="https://raw.githubusercontent.com/CS2103AUG2016-W13-C3/main/master/docs/images/Model API 2.PNG" max-width="600">
                    <img src="https://raw.githubusercontent.com/CS2103AUG2016-W13-C3/main/master/docs/images/Model API 3.PNG" max-width="600">
                    <figcaption>API of Model component</figcaption>
                </figure>
                ...
                <h3 id="storage-api">Storage API and Component</h3>

                <figure>
                    <img src="https://raw.githubusercontent.com/CS2103AUG2016-W13-C3/main/master/docs/images/Storage API.PNG" max-width="600">
                    <figcaption>API of Storage component</figcaption>
                </figure>
                ...
                <h2 id="implementation">Commons Implementation</h2>

                <h3 id="event-driven-design">Event Driven Design</h3>

                <p>
                    For components to inform one another that something has happened, we use <a href="https://github.com/google/guava/wiki/EventBusExplained">Google's Event Bus library</a>, packaged in <code>EventsCenter.java</code> within <code>seedu.commando.commons</code>. This is especially important for lower-level components to communicate with higher-level components that they should not be dependent on.
                </p>

                <blockquote>
                    All events should extend <code>BaseEvent.java</code> and be placed in package <code>seedu.commando.commons.events</code>.
                </blockquote>

                <p>
                    An example is the posting of <code>ExitAppRequestEvent</code> by <em>Logic</em> to inform <code>MainApp.java</code> to close the window:
                </p>

                <figure>
                    <img src="https://i.imgur.com/OvMZBs9.jpg" width="600">
                    <figcaption>Sequence Diagram of command <code>exit</code></figcaption>
                </figure>
...
``` html
                ...
                <h3>Eclipse reports compile errors after new commits are pulled from Git.</h3>
                ...
                <h3>Eclipse reports some required libraries missing.</h3>
                ...
                <p>No known issues, but probably unknown ones exist.</p>

                <h2 id="future-plans">Future Plans</h2>

                <p>To be filled in in the future.</p>
...
``` html
                ...
                <ol>
                    ...
                    <li>Should be able to hold up to 1000 tags per to-do</li>
                    ...
                    <li>Should not use more than 100MB of RAM</li>
                ...
                <ul>
                    <li>
                        <strong>Mainstream OS</strong>: Windows, Linux, Unix and OS-X.
                    </li>
                    <li>
                        <strong>Event</strong>: A to-do item that has a date range.
                    </li>

                    <li>
                        <strong>Task</strong>: A to-do item without a date range, and optionally has a deadline.
                    </li>
                    <li>
...
``` html
                <blockquote>
                    <b>To-Dos Containing Command Keywords:</b> To parse commands properly, <em>CommanDo</em> uses a set of keywords such as <code>by</code>, <code>from</code>, and <code>to</code>. <em>CommanDo</em> tries its best to determine whether a word is supposed to be a keyword or part of a field by checking the validity of datetimes. When there are multiple valid interpretations of a command with multiple command keywords, the trailing command keyword will be prioritised.
                </blockquote>
...
``` html
                ...
                <p>
                    ...
                    <ul id="search-logic">
                        ...
                        <li>
                            Orderings of the search keywords and tags do not matter â€? keywords <code>Chicken Egg</code> will match <code> Egg Chicken</code>.
                        </li>
                        <li>
