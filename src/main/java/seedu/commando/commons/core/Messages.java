...
public class Messages {
    ...
    public static final String MESSAGE_MISSING_TODO_TITLE = "Missing value for to-do.";
    ...
    public static final String MESSAGE_TODO_NO_EDITS = "Nothing interesting happens.";
    public static final String MESSAGE_TODO_ALREADY_FINISHED = "To-do already finished: %1$s";
